...
public class PenStyleBar extends ClearPanel {
    private final ImageButton colorButton = new ImageButton("颜色",getClass().getResource("/images/MenuBar/PenStyle/colorBoard.png"));
    private final ImageButton lineWidthButton = new ImageButton("线宽",getClass().getResource("/images/MenuBar/PenStyle/strokewidth.png"));
    private final ImageButton fontFamilyButton = new ImageButton("字体", getClass().getResource("/images/MenuBar/PenStyle/fontChange.png"));
    private final ImageButton fontSizeButton = new ImageButton("字号",getClass().getResource("/images/MenuBar/PenStyle/fontsize.png"));
